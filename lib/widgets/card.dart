              ...
              children: [
                Padding(
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      child: feito ? Icon(Icons.check, size: 16,) : null,
                      width: 20,
                      height: 20,
                      decoration: BoxDecoration(
                          color: feito ? Colors.green[300] : Colors.white70,
                          borderRadius: BorderRadius.circular(6),
                          border:  feito ? null : Border.all(
                              color: Colors.grey,
                              width: 2
                          )
                      ),
                ...
                Padding(
                  ...
                  child: Text(widget.titulo ?? "Sem titulo", style: TextStyle(
              ...
              child: Row(
                children: [
                  Padding(
                    ...
                    child: Text(widget.descricao ?? "Adicione uma descrição", style: TextStyle(
                      color: feito ? Colors.green : Colors.black,
                      fontSize: 15,
                    )),
                  ),
